(function() {
	...
	angular.module('rampup')
		.controller('InorderController', InorderController);

	/** @ngInject */
	function InorderController(BinarySearchTree, Traversal) {
		var vm = this;

		vm.title = "Inorder Traversing";
		...
		function generateTreeLog() {
			var log = "";
			Traversal.inorder(vm.tree._root, function(node) {
				log += node.key + "  ";
			}, this);
			return log;
		}
